              ...
              <div style={{ position: 'relative', zIndex: searchSelectOpen ? 30 : 1 }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: '8px 12px',
                    borderRadius: '12px',
                    border: searchSelectOpen ? '1.5px solid #8E44AD' : '1.5px solid #E8ECF0',
                    fontFamily: 'Nunito, sans-serif',
                    fontWeight: 700,
                    fontSize: '0.9rem',
                    color: '#2C3E50',
              ...
              <div style={{ position: 'relative', zIndex: monthDropdownOpen ? 30 : 1 }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: '10px 12px',
                    borderRadius: '12px',
                    border: monthDropdownOpen ? '1.5px solid #8E44AD' : '1.5px solid #E8ECF0',
                    fontFamily: 'Nunito, sans-serif',
                    fontWeight: 700,
                    fontSize: '0.9rem',
                    color: '#2C3E50',
              ...
              <div style={{ position: 'relative', zIndex: yearDropdownOpen ? 30 : 1 }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: '10px 12px',
                    borderRadius: '12px',
                    border: yearDropdownOpen ? '1.5px solid #8E44AD' : '1.5px solid #E8ECF0',
                    fontFamily: 'Nunito, sans-serif',
                    fontWeight: 700,
                    fontSize: '0.9rem',
                    color: '#2C3E50',
