...
const NAV_ITEMS = [
  { href: '/teacher/dashboard', emoji: '🏠', label: 'Beranda', isBell: false },
  { href: '/teacher/rekap', emoji: '📊', label: 'Rekap', isBell: false },
            ...
            <div className="modal-body" style={{ textAlign: 'center', padding: '24px 20px' }}>
              <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '16px' }}>
                <div style={{
                  ...
                  height: '70px',
                  borderRadius: '50%',
                  background: 'linear-gradient(135deg, #D5F5E3, #27AE60)',
                  display: 'flex',
                  alignItems: 'center',
